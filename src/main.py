...
#%%
    #sdnn_correlations
    sdnn_results, sdnn_interp_pairs = process_meas_and_find_corr(sdnn_list)
    save_final_pairs_plots(sdnn_results, sdnn_interp_pairs, folder_name="sdnn_results", title_label="interpolated and paired Standard Deviation of NN-intervals", value_label="SDNN [ms]")
    write_to_excel(sdnn_results, ANALYSIS_DATA_DIR / "sdnn_results.xlsx")
